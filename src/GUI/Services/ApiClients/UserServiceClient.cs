...
namespace LT.DigitalOffice.GUI.Services.ApiClients.UserService
{
    ...
    public partial class UserServiceClient
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<UsersResponse> FindUsersAsync(string token, System.Guid? departmentId, int skipCount, int takeCount)
        {
        ...
        /// * Successfully returned list of users information.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<UsersResponse> FindUsersAsync(string token, System.Guid? departmentId, int skipCount, int takeCount, System.Threading.CancellationToken cancellationToken)
        {
            if (skipCount == null)

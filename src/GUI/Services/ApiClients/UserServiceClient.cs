...
namespace LT.DigitalOffice.GUI.Services.ApiClients.UserService
{
	...
	{
    private string _baseUrl = "http://localhost:9802";//"https://user.dev.ltdo.xyz";
		...
		/// <param name="includeimages">Include certificate and achievments images content in answer.</param>
		/// <param name="includeuserimages">Include user images content in answer.</param>
		/// <param name="includeeducations">Include educations info in answer.</param>
		/// <returns>Created.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<OperationResultResponseUserResponse> GetUserAsync(string token, System.Guid? userId, string name, string email, bool? includecommunications, bool? includecertificates, bool? includeachievements, bool? includedepartment, bool? includeposition, bool? includeoffice, bool? includerole, bool? includeskills, bool? includeprojects, bool? includeimages, bool? includeuserimages, bool? includeeducations)
		{
			return GetUserAsync(token, userId, name, email, includecommunications, includecertificates, includeachievements, includedepartment, includeposition, includeoffice, includerole, includeskills, includeprojects, includeimages, includeuserimages, includeeducations, System.Threading.CancellationToken.None);
		}
		...
		public async System.Threading.Tasks.Task<OperationResultResponseUserResponse> GetUserAsync(string token, System.Guid? userId, string name, string email, bool? includecommunications, bool? includecertificates, bool? includeachievements, bool? includedepartment, bool? includeposition, bool? includeoffice, bool? includerole, bool? includeskills, bool? includeprojects, bool? includeimages, bool? includeuserimages, bool? includeeducations, System.Threading.CancellationToken cancellationToken)
		{
			...
			if (includeuserimages != null)
			{
				urlBuilder_.Append(System.Uri.EscapeDataString("includeuserimages") + "=").Append(System.Uri.EscapeDataString(ConvertToString(includeuserimages, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
			}
		...
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<FindResultResponseUserInfo> FindUsersAsync(string token, int skipCount, int takeCount, bool? includedeactivated, bool? includedepartment, bool? includeposition, bool? includeoffice, bool? includerole, bool? includeavatar)
		{
			return FindUsersAsync(token, skipCount, takeCount, includedeactivated, includedepartment, includeposition, includeoffice, includerole, includeavatar, System.Threading.CancellationToken.None);
		}
		...
		/// <br/>* Successfully returned list of users information.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public async System.Threading.Tasks.Task<FindResultResponseUserInfo> FindUsersAsync(string token, int skipCount, int takeCount, bool? includedeactivated, bool? includedepartment, bool? includeposition, bool? includeoffice, bool? includerole, bool? includeavatar, System.Threading.CancellationToken cancellationToken)
		{
			if (skipCount == null)
			...
			if (includeavatar != null)
			{
				urlBuilder_.Append(System.Uri.EscapeDataString("includeavatar") + "=").Append(System.Uri.EscapeDataString(ConvertToString(includeavatar, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
			}
			urlBuilder_.Length--;
		...
		/// <returns>Ok.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<OperationResultResponse> CheckPendingCredentialsAsync(System.Guid userid)
		{
			return CheckPendingCredentialsAsync(userid, System.Threading.CancellationToken.None);
		}
		...
		/// <returns>Ok.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public async System.Threading.Tasks.Task<OperationResultResponse> CheckPendingCredentialsAsync(System.Guid userid, System.Threading.CancellationToken cancellationToken)
		{
			if (userid == null)
				throw new System.ArgumentNullException("userid");

			var urlBuilder_ = new System.Text.StringBuilder();
			urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/credentials/checkpending?");
			urlBuilder_.Append(System.Uri.EscapeDataString("userid") + "=").Append(System.Uri.EscapeDataString(ConvertToString(userid, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
			urlBuilder_.Length--;
		...
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<OperationResultResponse> ChangePasswordAsync(ChangePasswordRequest body)
		{
		...
		/// <br/>* Change user password operation success (boolean) status will be in response Body property.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public async System.Threading.Tasks.Task<OperationResultResponse> ChangePasswordAsync(ChangePasswordRequest body, System.Threading.CancellationToken cancellationToken)
		{
			var urlBuilder_ = new System.Text.StringBuilder();
				...
				using (var request_ = new System.Net.Http.HttpRequestMessage())
				{
					...
					try
					{
						...
						if (status_ == 409)
						{
							...
							throw new ApiException<ErrorResponse>("Conflict.\n* Token was not entered.\n* Invalid token.\n* User has not rights.\n", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
						}
						else
						{
							var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
		...
		/// <returns>Ok.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<OperationResultResponse> EditCommunicationAsync(System.Collections.Generic.IEnumerable<CommunicationPatchDocument> body, string token, System.Guid communicationId)
		{
		...
		/// <returns>Ok.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public async System.Threading.Tasks.Task<OperationResultResponse> EditCommunicationAsync(System.Collections.Generic.IEnumerable<CommunicationPatchDocument> body, string token, System.Guid communicationId, System.Threading.CancellationToken cancellationToken)
		{
		...
		/// <param name="token">The JWT token.</param>
		/// <returns>Ok. Image was added to entity.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<OperationResultResponse> CreateImageAsync(CreateImageRequest body, string token)
		{
			return CreateImageAsync(body, token, System.Threading.CancellationToken.None);
		}
		...
		/// <returns>Ok. Image was added to entity.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public async System.Threading.Tasks.Task<OperationResultResponse> CreateImageAsync(CreateImageRequest body, string token, System.Threading.CancellationToken cancellationToken)
		{
			if (body == null)
				throw new System.ArgumentNullException("body");

			var urlBuilder_ = new System.Text.StringBuilder();
			urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/image/create");
				...
				using (var request_ = new System.Net.Http.HttpRequestMessage())
				{
					...
					try
					{
						...
						if (status_ == 502)
						{
							...
							throw new ApiException<ErrorResponse>("Bad Gateway. Something goes wrong on the server\'s side", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
						}
						else
						{
							var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
		...
		/// <returns>Ok.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<OperationResultResponse> GetImagesAsync(string token, System.Guid entityId, EntityType entityType)
		{
			return GetImagesAsync(token, entityId, entityType, System.Threading.CancellationToken.None);
		}
		...
		/// <returns>Ok.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public async System.Threading.Tasks.Task<OperationResultResponse> GetImagesAsync(string token, System.Guid entityId, EntityType entityType, System.Threading.CancellationToken cancellationToken)
		{
			if (entityId == null)
				...
				using (var request_ = new System.Net.Http.HttpRequestMessage())
				{
					...
					try
					{
						...
						if (status_ == 404)
						{
							...
							throw new ApiException<ErrorResponse>("Images were not found.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
						}
						else
						{
							var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
		...
		/// <returns>Ok.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<OperationResultResponse> RemoveImagesAsync(RemoveImagesRequest body, string token)
		{
			return RemoveImagesAsync(body, token, System.Threading.CancellationToken.None);
		}
		...
		/// <returns>Ok.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public async System.Threading.Tasks.Task<OperationResultResponse> RemoveImagesAsync(RemoveImagesRequest body, string token, System.Threading.CancellationToken cancellationToken)
		{
			if (body == null)
				throw new System.ArgumentNullException("body");

			var urlBuilder_ = new System.Text.StringBuilder();
			urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/image/remove");
		...
		/// <returns>Ok.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<OperationResultResponse> ChangeAvatarAsync(string token, System.Guid userId, System.Guid imageId)
		{
			return ChangeAvatarAsync(token, userId, imageId, System.Threading.CancellationToken.None);
		}
		...
		/// <returns>Ok.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public async System.Threading.Tasks.Task<OperationResultResponse> ChangeAvatarAsync(string token, System.Guid userId, System.Guid imageId, System.Threading.CancellationToken cancellationToken)
		{
			if (userId == null)
				throw new System.ArgumentNullException("userId");
			...
			var urlBuilder_ = new System.Text.StringBuilder();
			urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/image/editavatar?");
			urlBuilder_.Append(System.Uri.EscapeDataString("userId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(userId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
		...
		/// <param name="token">The JWT token.</param>
		/// <returns>Ok. Skill was created.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<OperationResultResponse> CreateSkillAsync(CreateSkillRequest body, string token)
		{
			return CreateSkillAsync(body, token, System.Threading.CancellationToken.None);
		}
		...
		/// <returns>Ok. Skill was created.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public async System.Threading.Tasks.Task<OperationResultResponse> CreateSkillAsync(CreateSkillRequest body, string token, System.Threading.CancellationToken cancellationToken)
		{
			if (body == null)
				throw new System.ArgumentNullException("body");

			var urlBuilder_ = new System.Text.StringBuilder();
			urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/skill/create");
				...
				using (var request_ = new System.Net.Http.HttpRequestMessage())
				{
					...
					try
					{
						...
						if (status_ == 403)
						{
							...
							throw new ApiException<ErrorResponse>("Forbidden. Sender has no rights and not an admin", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
						}
						else
						if (status_ == 409)
						{
							...
							throw new ApiException<ErrorResponse>("Conflict. Skill with that name already exist", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
						}
						else
						{
							var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
		...
		/// <param name="token">The JWT token.</param>
		/// <returns>Ok. Achievement was created.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<OperationResultResponse> CreateAchievementAsync(CreateAchievementRequest body, string token)
		{
			return CreateAchievementAsync(body, token, System.Threading.CancellationToken.None);
		}
		...
		/// <returns>Ok. Achievement was created.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public async System.Threading.Tasks.Task<OperationResultResponse> CreateAchievementAsync(CreateAchievementRequest body, string token, System.Threading.CancellationToken cancellationToken)
		{
			if (body == null)
				throw new System.ArgumentNullException("body");

			var urlBuilder_ = new System.Text.StringBuilder();
			urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/achievement/create");
		...
		/// <param name="token">The JWT token.</param>
		/// <param name="achievmentId">Achievement global unique identifier.</param>
		/// <returns>Ok.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<OperationResultResponse> EditAchievementAsync(EditAchievementRequest body, string token, System.Guid achievmentId)
		{
			return EditAchievementAsync(body, token, achievmentId, System.Threading.CancellationToken.None);
		}
		...
		/// <returns>Ok.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public async System.Threading.Tasks.Task<OperationResultResponse> EditAchievementAsync(EditAchievementRequest body, string token, System.Guid achievmentId, System.Threading.CancellationToken cancellationToken)
		{
			if (achievmentId == null)
				throw new System.ArgumentNullException("achievmentId");

			if (body == null)
				throw new System.ArgumentNullException("body");

			var urlBuilder_ = new System.Text.StringBuilder();
			urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/achievement/edit?");
			urlBuilder_.Append(System.Uri.EscapeDataString("achievmentId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(achievmentId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
			urlBuilder_.Length--;
		...
		/// <param name="token">The JWT token.</param>
		/// <param name="achievmentId">Achievement global unique identifier.</param>
		/// <returns>Successfully returned achievment information.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<OperationResultResponseAchievementResponse> GetAchievementAsync(string token, System.Guid achievmentId)
		{
			return GetAchievementAsync(token, achievmentId, System.Threading.CancellationToken.None);
		}
		...
		/// <returns>Successfully returned achievment information.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public async System.Threading.Tasks.Task<OperationResultResponseAchievementResponse> GetAchievementAsync(string token, System.Guid achievmentId, System.Threading.CancellationToken cancellationToken)
		{
			if (achievmentId == null)
				throw new System.ArgumentNullException("achievmentId");

			var urlBuilder_ = new System.Text.StringBuilder();
			urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/achievement/get?");
			urlBuilder_.Append(System.Uri.EscapeDataString("achievmentId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(achievmentId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
			urlBuilder_.Length--;
			...
			try
			{
				using (var request_ = new System.Net.Http.HttpRequestMessage())
				{
					...
					try
					{
						...
						if (status_ == 200)
						{
							var objectResponse_ = await ReadObjectResponseAsync<OperationResultResponseAchievementResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
							if (objectResponse_.Object == null)
							{
								throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
							}
		...
		/// <param name="skipCount">Number of entries to skip.</param>
		/// <param name="takeCount">Number of users to take.</param>
		/// <returns>Successfully returned list of achievement.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<FindResultResponseAchievementInfo>> FindAchievementAsync(string token, int skipCount, int takeCount)
		{
			return FindAchievementAsync(token, skipCount, takeCount, System.Threading.CancellationToken.None);
		}
		...
		/// <returns>Successfully returned list of achievement.</returns>
		/// <exception cref="ApiException">A server side error occurred.</exception>
		public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<FindResultResponseAchievementInfo>> FindAchievementAsync(string token, int skipCount, int takeCount, System.Threading.CancellationToken cancellationToken)
		{
			if (skipCount == null)
				throw new System.ArgumentNullException("skipCount");
			...
			var urlBuilder_ = new System.Text.StringBuilder();
			urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/achievement/find?");
			urlBuilder_.Append(System.Uri.EscapeDataString("skipCount") + "=").Append(System.Uri.EscapeDataString(ConvertToString(skipCount, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
			urlBuilder_.Append(System.Uri.EscapeDataString("takeCount") + "=").Append(System.Uri.EscapeDataString(ConvertToString(takeCount, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
			urlBuilder_.Length--;
			...
			try
			{
				using (var request_ = new System.Net.Http.HttpRequestMessage())
				{
					...
					try
					{
						...
						if (status_ == 200)
						{
							var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<FindResultResponseAchievementInfo>>(response_, headers_, cancellationToken).ConfigureAwait(false);
							if (objectResponse_.Object == null)
							{
								throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
							}
	...
	/// <summary>Response object for action operations.</summary>
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v12.0.0.0)")]
	public partial class OperationResultResponseImagesIds
	{
		[Newtonsoft.Json.JsonProperty("Body", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
		public ImagesIds Body { get; set; }
	...
	public partial class CreateEducationRequest
	{
		...
		/// <summary>Array of education images.</summary>
		...
		public System.Collections.Generic.ICollection<AddImageRequest> Images { get; set; }
	...
	public partial class AddImageRequest
	{
		...
		/// <summary>shows whether the image is the current avatar or not</summary>
	...
	public partial class CreateCertificateRequest
	{
		...
		/// <summary>Array of certificate images.</summary>
		[Newtonsoft.Json.JsonProperty("Images", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
		public System.Collections.Generic.ICollection<AddImageRequest> Images { get; set; }
	...
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v12.0.0.0)")]
	public partial class EditCommunicationRequest : System.Collections.ObjectModel.Collection<CommunicationPatchDocument>
	{
	...
	{
		/// <summary>Unique entity (user/certificate/education) identifier.</summary>
		...
		[System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
		[Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
		public CreateImageRequestEntityType EntityType { get; set; }
	...
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v12.0.0.0)")]
	public partial class RemoveImagesRequest
	{
		/// <summary>Unique entity (user/certificate/education) identifier.</summary>
		[Newtonsoft.Json.JsonProperty("EntityId", Required = Newtonsoft.Json.Required.Always)]
		[System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
		...
		[System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
		[Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
		public RemoveImagesRequestEntityType EntityType { get; set; }

		[Newtonsoft.Json.JsonProperty("ImagesIds", Required = Newtonsoft.Json.Required.Always)]
		[System.ComponentModel.DataAnnotations.Required]
		public ImagesIds ImagesIds { get; set; } = new ImagesIds();
	...
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v12.0.0.0)")]
	public partial class ImagesIds : System.Collections.ObjectModel.Collection<System.Guid>
	{
	...
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v12.0.0.0)")]
	public partial class CreateAchievementRequest
	{
		/// <summary>Unique name of the achievement.</summary>
		[Newtonsoft.Json.JsonProperty("Name", Required = Newtonsoft.Json.Required.Always)]
		[System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
		public string Name { get; set; }

		/// <summary>Description of the achievment.</summary>
		[Newtonsoft.Json.JsonProperty("Description", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
		public string Description { get; set; }
	...
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v12.0.0.0)")]
	public partial class EditAchievementRequest
	{
		/// <summary>Unique name of the achievement.</summary>
		[Newtonsoft.Json.JsonProperty("Name", Required = Newtonsoft.Json.Required.Always)]
		[System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
	...
	/// <summary>Response object for action operations.</summary>
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v12.0.0.0)")]
	public partial class OperationResultResponseAchievementResponse
	{
		[Newtonsoft.Json.JsonProperty("Body", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
	...
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v12.0.0.0)")]
	public partial class FindResultResponseAchievementInfo
	{
		[Newtonsoft.Json.JsonProperty("Status", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
		[Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
		public OperationResultStatusType Status { get; set; }

		/// <summary>Total number of finded by filter achievement.</summary>
		[Newtonsoft.Json.JsonProperty("TotalCount", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
	...
	public enum PatchUserDocumentPath
	{
		...
		[System.Runtime.Serialization.EnumMember(Value = @"/AvatarFileId")]
		_AvatarFileId = 6,
	...
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v12.0.0.0)")]
	public enum CreateImageRequestEntityType
	{
		[System.Runtime.Serialization.EnumMember(Value = @"user")]
		User = 0,
	...
	[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v12.0.0.0)")]
	public enum RemoveImagesRequestEntityType
	{
		[System.Runtime.Serialization.EnumMember(Value = @"user")]
		User = 0,

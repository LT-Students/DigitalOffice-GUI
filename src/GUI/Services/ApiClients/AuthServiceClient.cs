...
namespace LT.DigitalOffice.GUI.Services.ApiClients.AuthService
{
  ...
  {
    private string _baseUrl = "https://auth.dev.ltdo.xyz"; /*"http://localhost:9818"*/
    ...
    /// <returns>Successfully user authentication, returned a user id and tokens.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public System.Threading.Tasks.Task<AuthenticationResponse> LoginAsync(AuthenticationRequest body)
    {
    ...
    /// <returns>Successfully user authentication, returned a user id and tokens.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public async System.Threading.Tasks.Task<AuthenticationResponse> LoginAsync(AuthenticationRequest body, System.Threading.CancellationToken cancellationToken)
    {
      if (body == null)
    ...
    /// <returns>Ok. New tokens will be in response.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public System.Threading.Tasks.Task<AuthenticationResponse> RefreshAsync(RefreshRequest body)
    {
    ...
    /// <returns>Ok. New tokens will be in response.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public async System.Threading.Tasks.Task<AuthenticationResponse> RefreshAsync(RefreshRequest body, System.Threading.CancellationToken cancellationToken)
    {
      if (body == null)
        throw new System.ArgumentNullException("body");
  ...
  {
    /// <summary>User email or login.</summary>
    [Newtonsoft.Json.JsonProperty("LoginData", Required = Newtonsoft.Json.Required.Always)]
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
  ...
  {
    /// <summary>User global unique identifier.</summary>
    [Newtonsoft.Json.JsonProperty("UserId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    public System.Guid UserId { get; set; }

    /// <summary>User access JWT.</summary>
    ...
    /// <summary>User refresh JWT.</summary>

...
namespace LT.DigitalOffice.GUI.Services.ApiClients.CompanyService
{
    ...
    public partial class CompanyServiceClient
    {
        ...
        /// <returns>Ok.
        /// * Update position operation success (boolean) status will be in response Body property.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        ...
        /// <returns>Ok.
        /// * Update department operation success (boolean) status will be in response Body property.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>

...
namespace LT.DigitalOffice.GUI.Services.ApiClients.ProjectService
{
    ...
    public partial class ProjectServiceClient 
    {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<FindResponseProjectInfo>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(FindResponseProjectInfo);
                    }
                    finally
                    {
                        if (response_ != null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ProjectResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "403") 
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<OperationResultResponseProjectInfo>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "400") 
                        ...
                        return default(OperationResultResponseProjectInfo);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<OperationResultResponse> EditProjectAsync(System.Collections.Generic.IEnumerable<object> body, string token, System.Guid projectId)
        {
        ...
        /// <returns>Project respose.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<OperationResultResponse> EditProjectAsync(System.Collections.Generic.IEnumerable<object> body, string token, System.Guid projectId, System.Threading.CancellationToken cancellationToken)
        {
            if (projectId == null)
                throw new System.ArgumentNullException("projectId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<OperationResultResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "400") 
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Not Found. * Project with this id not found.", (int)response_.StatusCode, responseText_, headers_, null);
                        }
                        else
                        if (status_ != "200" && status_ != "204")
                        {
                        ...
                        return default(OperationResultResponse);
                    }
                    finally
                    {
                        if (response_ != null)
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "204") 
                        {
                            ...
                            throw new ApiException<System.Guid>("Project\'s Id.", (int)response_.StatusCode, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == "400") 
                        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Not Found. * User or Project with this id not found.", (int)response_.StatusCode, responseText_, headers_, null);
                        }
                        else
                        if (status_ != "200" && status_ != "204")
                        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Not Found. * Task with this id not found.", (int)response_.StatusCode, responseText_, headers_, null);
                        }
                        else
                        if (status_ != "200" && status_ != "204")
                        {
        ...
        /// <param name="projectid">The part of find query that the task shortname should contain.</param>
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<FindResponseTaskInfo>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ == "403") 
                        ...
                        return default(FindResponseTaskInfo);
                    }
                    finally
                    {
                        if (response_ != null)
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.22.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class EditProjectRequest : System.Collections.ObjectModel.Collection<object>
    {
        /// <summary>The operation to be performed</summary>
        [Newtonsoft.Json.JsonProperty("op", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public EditProjectRequestOp Op { get; set; }
    
        /// <summary>A JSON-Pointer.</summary>
        [Newtonsoft.Json.JsonProperty("path", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public EditProjectRequestPath Path { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.22.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EditProjectRequestOp
    {
        [System.Runtime.Serialization.EnumMember(Value = @"replace")]
        Replace = 0,
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.22.0 (Newtonsoft.Json v11.0.0.0)")]
    public enum EditProjectRequestPath
    {
        [System.Runtime.Serialization.EnumMember(Value = @"/Name")]
        _Name = 0,
